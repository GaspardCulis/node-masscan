...
var Masscan = /** @class */ (function (_super) {
    ...
    Masscan.prototype.start = function (range, ports, max_rate, exclude_file) {
         ...
         * @private
         */
        this._process = child_process.execFile(this.masscan_path, args.split(" "), {
            maxBuffer: 1024 * 1024 * 1024,
        });
        (_a = this._process.stdout) === null || _a === void 0 ? void 0 : _a.on("data", function (chunk) {
        ...
        (_b = this._process.stderr) === null || _b === void 0 ? void 0 : _b.on("data", function (chunk) {
        ...
        this._process.once("exit", function (err) {
            if (err == 1) {
